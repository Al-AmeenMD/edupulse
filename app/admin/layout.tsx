...
export default function AdminLayout({
  ...
  return (
    <AppShell
      allowedRoles={["SCHOOL_ADMIN", "FINANCE_ADMIN"]}
      navItems={(user) =>
        user.role === "FINANCE_ADMIN"
          ? financeAdminNavItems
          : schoolAdminNavItems
      }
      portalName={(user) =>
        user.role === "FINANCE_ADMIN"
      ...
      roleTitle={(user) =>
        user.role === "FINANCE_ADMIN" ? "Finance Admin" : "School Admin"
      }
      badgeLabel={(user) => {
      ...
      headerTitle={(user) => user.schoolName || "School Management Workspace"}
      brandLetter="E"
      theme="navy"
      collapsible={true}
    >
